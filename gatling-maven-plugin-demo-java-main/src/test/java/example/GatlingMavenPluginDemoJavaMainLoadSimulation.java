...
public class GatlingMavenPluginDemoJavaMainLoadSimulation extends Simulation {
  ...
  private static final int USERS = Integer.getInteger("users", 500);
  ...
  private static final HttpProtocolBuilder HTTP_PROTOCOL =
      http.baseUrl(BASE_URL)
          ...
          .userAgentHeader("Gatling Maven Plugin Demo Java Main Load");
  ...
  private static final ScenarioBuilder LOGIN_SCENARIO =
      scenario("gatling-maven-plugin-demo-java-main login load")
